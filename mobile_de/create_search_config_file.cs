...
+ $"{Environment.NewLine}        \"Подержанные автомобили\": {condition_used_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}        \"Только новые автомобили\": {condition_new_checkBox.Checked.ToString().ToLower()}"
+ $"{Environment.NewLine}    }},"
...
+ $"{Environment.NewLine}        \"SUV / Off-road Vehicle / Pickup Truck\": {vehicle_type_suv_off_road_vehicle_pickup_truck_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}        \"Кабриолет / родстер\": {vehicle_type_cabriolet_roadster_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}        \"Малолитражный автомобиль\": {vehicle_type_small_car_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}        \"Минивэн / микроавтобус\": {vehicle_type_van_minibus_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}        \"Седан\": {vehicle_type_sedan_checkBox.ToString().ToLower()},"
+ $"{Environment.NewLine}        \"Спортивный автомобиль/купе\": {vehicle_type_sports_car_coupe_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}        \"Универсал\": {vehicle_type_kombi_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}        \"Иное\": {vehicle_type_other_checkBox.Checked.ToString().ToLower()},"
...
+ $"{Environment.NewLine}        ],"
+ $"{Environment.NewLine}        \"Металлик\": {vehicle_search_metallic_checkBox.Checked.ToString().ToLower()}"
+ $"{Environment.NewLine}    }},"
+ $"{Environment.NewLine}    \"Двигатель\": {{"
+ $"{Environment.NewLine}        \"Вид топлива\": {{"
+ $"{Environment.NewLine}            \"Бензиновый\": {engine_fuel_type_petrol_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Дизельный\": {engine_fuel_type_diesel_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Электрический\": {engine_fuel_type_electric_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Этанол (FFV, E85 и т.п.)\": {engine_fuel_type_ethanol_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Гибридный (бензин/электричество)\": {engine_fuel_type_hybrid_petrol_electric_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Гибрид (дизельный / электрический)\": {engine_fuel_type_hybrid_diesel_electric_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Сжиженный нефтяной газ\": {engine_fuel_type_lpg_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Природный газ\": {engine_fuel_type_natural_gas_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Водород\": {engine_fuel_type_hydrogen_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Иное\": {engine_fuel_type_other_checkBox.Checked.ToString().ToLower()}"
+ $"{Environment.NewLine}        }},"
+ $"{Environment.NewLine}        \"Коробка передач\": {{"
+ $"{Environment.NewLine}            \"Автоматическая КП\": {engine_transmission_automatic_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Механическая коробка передач\": {engine_transmission_manual_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Полуавтоматическая КП\": {engine_transmission_semi_automatic_checkBox.Checked.ToString().ToLower()}"
+ $"{Environment.NewLine}        }},"
...
+ $"{Environment.NewLine}            \"Bluetooth\": {features_interior_features_bluetooth_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"CD-проигрыватель\": {features_interior_features_cd_player_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Isofix (крепления детских сидений)\": {features_interior_features_isofix_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"MP3-интерфейс\": {features_interior_features_mp3_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Автоматический датчик дождя\": {features_interior_features_rain_sensor_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Бортовой компьютер\": {features_interior_features_on_board_computer_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Вентилируемые сиденья\": {features_interior_features_seat_ventilation_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Вспомогательный обогреватель\": {features_interior_features_auxiliary_heating_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Комплект громкой связи\": {features_interior_features_voice_control_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Круиз-контроль\": {features_interior_features_cruise_control_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Люк в крыше\": {features_interior_features_sunroof_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Многофункциональное рулевое колесо\": {features_interior_features_multifunction_steering_wheel_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Навигационная система\": {features_interior_features_navigation_system_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Подогрев сидений\": {features_interior_features_electric_heated_seats_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Рулевой механизм с усилителем\": {features_interior_features_leather_steering_wheel_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Система индикации на лобовом стекле\": {features_interior_features_head_up_display_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Стартстопная система\": {features_interior_features_start_stop_system_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Тюнер/радио\": {features_interior_features_radio_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Центральный замок\": {features_interior_features_central_locking_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Чехол для лыж\": {features_interior_features_ski_bag_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Электрическая регулировка сидений\": {features_interior_features_electric_seat_adjustment_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Электрические стеклоподъемники\": {features_interior_features_electric_windows_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Электрическое боковое зеркало\": {features_interior_features_electric_side_mirror_checkBox.Checked.ToString().ToLower()}"
+ $"{Environment.NewLine}        }},"
+ $"{Environment.NewLine}        \"Безопасность\": {{"
+ $"{Environment.NewLine}            \"ABS\": {features_security_abs_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"ESP\": {features_security_esp_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Адаптивное освещение поворотов\": {features_security_adaptive_cornering_lighting_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Адаптивный круиз-контроль\": {features_security_adaptive_cruise_control_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Датчик света\": {features_security_light_sensor_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Дневные ходовые огни\": {features_security_daytime_running_lights_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Иммобилайзер\": {features_security_immobilizer_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Ксеноновые фары\": {features_security_xenon_headlights_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Привод на четыре колеса\": {features_security_four_wheel_drive_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Противобуксовочная система\": {features_security_traction_control_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Противотуманная фара\": {features_security_fog_lamp_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Светодиодные фары\": {features_security_led_headlights_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Система бесключевого доступа к автомобилю\": {features_security_keyless_central_locking_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Система избежания столкновений\": {features_security_emergency_brake_assist_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Система мониторинга слепых зон\": {features_security_blind_spot_assist_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Система предупреждения о сходе с полосы движения\": {features_security_lane_change_assist_checkBox.Checked.ToString().ToLower()}"
+ $"{Environment.NewLine}        }},"
+ $"{Environment.NewLine}        \"Подушки безопасности\": \"{features_airbags_comboBox.Text}\","
+ $"{Environment.NewLine}        \"Датчики парковки\": {{"
+ $"{Environment.NewLine}            \"Сзади\": {features_parking_sensors_rear_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Спереди\": {features_parking_sensors_front_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Камера\": {features_parking_sensors_camera_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Системы автоматического рулевого управления\": {features_parking_sensors_features_steering_systems_checkBox.Checked.ToString().ToLower()}"
+ $"{Environment.NewLine}        }},"
+ $"{Environment.NewLine}        \"Спортивные\": {{"
+ $"{Environment.NewLine}            \"Спортивная подвеска\": {features_sports_suspension_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Спортивные сиденья\": {features_sports_seats_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Спортивный пакет\": {features_sports_package_checkBox.Checked.ToString().ToLower()}"
+ $"{Environment.NewLine}        }},"
+ $"{Environment.NewLine}        \"Опции\": {{"
+ $"{Environment.NewLine}            \"Багажник на крыше\": {features_extras_roof_rack_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Колеса из легкого сплава\": {features_extras_alloy_wheels_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Стеклянная крыша для панорамного обзора\": {features_extras_panoramic_roof_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"С устройством для доступа инвалидов\": {features_extras_disabled_accessible_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Сцепное устройство прицепа\": {features_extras_huck_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Такси\": {features_extras_taxi_checkBox.Checked.ToString().ToLower()}"
+ $"{Environment.NewLine}        }},"
+ $"{Environment.NewLine}        \"Тип салона\": {{"
+ $"{Environment.NewLine}            \"Полностью из кожи\": {features_interior_material_full_leather_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Частично из кожи\": {features_interior_material_part_leather_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Обивка\": {features_interior_material_cloth_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Велюр\": {features_interior_material_velour_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Алькантара\": {features_interior_material_alcantara_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Другое\": {features_interior_material_other_checkBox.Checked.ToString().ToLower()}"
+ $"{Environment.NewLine}        }},"
+ $"{Environment.NewLine}        \"Цвет салона\": {{"
+ $"{Environment.NewLine}            \"Черный\": {features_interior_colour_black_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Серый\": {features_interior_colour_grey_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Бежевый\": {features_interior_colour_beige_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Коричневый\": {features_interior_colour_brown_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Другое\": {features_interior_colour_other_checkBox.Checked.ToString().ToLower()}"
+ $"{Environment.NewLine}        }}"
+ $"{Environment.NewLine}    }},"
...
+ $"{Environment.NewLine}        \"Объявления с фото\": {offer_details_ads_with_pictures_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}        \"Объявления с видео\": {offer_details_ads_with_video_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}        \"Горячие предложения\": {offer_details_discount_offers_checkBox.Checked.ToString().ToLower()},"
...
+ $"{Environment.NewLine}        \"Пылевой фильтр\": {environment_particulate_filter_checkBox.Checked.ToString().ToLower()}"
+ $"{Environment.NewLine}    }},"
+ $"{Environment.NewLine}    \"История транспортного средства\": {{"
+ $"{Environment.NewLine}        \"Гарантия\": {vehicle_history_warranty_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}        \"Машина некурящего водителя\": {vehicle_history_non_smoker_vehicle_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}        \"Полная история обслуживания\": {vehicle_history_full_service_history_checkBox.Checked.ToString().ToLower()},"
...
+ $"{Environment.NewLine}        \"Пригодно к эксплуатации\": {vehicle_history_ready_for_use_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}        \"Подкатегория\": {{"
+ $"{Environment.NewLine}            \"Демонстрационное транспортное средство\": {vehicle_history_vehicle_type_demonstration_vehicle_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Олдтаймер\": {vehicle_history_vehicle_type_classic_vehicle_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Предварительная регистрация\": {vehicle_history_vehicle_type_pre_registration_checkBox.Checked.ToString().ToLower()},"
+ $"{Environment.NewLine}            \"Служебный автомобиль\": {vehicle_history_vehicle_type_employees_car_checkBox.Checked.ToString().ToLower()}"
+ $"{Environment.NewLine}        }}"
+ $"{Environment.NewLine}    }}"
+ $"{Environment.NewLine}}}";
